...
| `Manage-Privilege.ps1` — `-StartProfile`/`-AutoConnect` startup, `Invoke-ProfileConnect` | No (UI/interactive; `-AutoConnect`'s parameter validation was spot-checked directly) | — | Yes (manual — D31-D36 below) |
