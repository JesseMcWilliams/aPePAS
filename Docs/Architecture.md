...
- **IgnoreSSL**: Stored per profile. When enabled, a warning is logged at session start. Only
  ...
  correctly reset on the very next API call made with `IgnoreSSL=$false` (Testing-Plan.md K02/F57),
