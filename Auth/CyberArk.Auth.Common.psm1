...
# so importing it here does not create a circular reference. See Testing_Findings-and-Known-Issues.md K02/F57.
...
function Invoke-WebView2Window {
    param(
        ...
        # See Testing_Findings-and-Known-Issues.md K03: the WebView2 control wraps its own Chromium/CoreWebView2
...
function Get-ISPSSAuthThrottle {
    ...
    .DESCRIPTION
        ...
        for an identity. Confirmed live (Testing_Findings-and-Known-Issues.md K17): repeated attempts within this
