...
function Invoke-SelfHostedPasswordAuth {
    param(
        ...
        # Use-StoredCredentialIfMissing and Testing_Findings-and-Known-Issues.md K06. Automated runs must never fall
...
function Update-SelfHostedAuthToken {
    ...
    .PARAMETER NoPrompt
        ...
        prompt when the stored _RefreshContext has no usable credential - see Testing_Findings-and-Known-Issues.md K06.
    #>
    [CmdletBinding()]
    param(
