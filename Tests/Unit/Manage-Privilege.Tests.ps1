...
Describe 'Manage-Privilege - Profile persistence (Save / Read / GetAll)' {
    ...
    It 'DP10a - Get-AllDriverProfiles ignores a stray .auththrottle sidecar file in the profile directory (Testing_Plan.md K17)' {
    ...
    It 'DP11b - Get-AllDriverProfiles backfills WebView2AssemblyPath on an older profile saved without it, and it can then be assigned (Testing_Plan.md K13)' {
...
# once before - see "Pester v6 Test File Structure" in Reference_Lessons-Learned.md),
